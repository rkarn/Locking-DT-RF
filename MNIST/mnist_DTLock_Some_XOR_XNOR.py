def dtLOCKED_Some_XOR_XNOR(feature_set,key):
  ...
  if (feature2 <= 361) and not((feature2 <= 361) ^ key[0])==(feature2 <= 361)  :
    if (feature3 <= 99) and ((feature3 <= 99) ^ key[1])==(feature3 <= 99)  :
      if (feature7 <= 10) and not((feature7 <= 10) ^ key[2])==(feature7 <= 10)  :
        ...
        if (feature1 <= 831) and not((feature1 <= 831) ^ key[3])==(feature1 <= 831)  :
          return 2
        else:  # if feature1 > 831.0
          return 0
    else:  # if feature3 > 99.0
      if (feature3 <= 394) and not((feature3 <= 394) ^ key[4])==(feature3 <= 394)  :
        if (feature5 <= 137) and ((feature5 <= 137) ^ key[5])==(feature5 <= 137)  :
          if (feature2 <= 317) and not((feature2 <= 317) ^ key[6])==(feature2 <= 317)  :
            if (feature2 <= 279) and not ((feature2 <= 279) ^ key[7])==(feature2 <= 279)  :
              return 2
            ...
            if (feature1 <= 913) and ((feature1 <= 913) ^ key[10])==(feature1 <= 913)  :
              return 2
        ...
        if (feature0 <= 0) : 
          if (feature3 <= 401) and not((feature3 <= 401) ^ key[12])==(feature3 <= 401)  :
            if (feature5 <= 397) and ((feature5 <= 397) ^ key[13])==(feature5 <= 397)  :
          ...
          if (feature3 <= 541) and ((feature3 <= 541) ^ key[16])==(feature3 <= 541)  :
            ...
            if (feature5 <= 219) and ((feature5 <= 219) ^ key[17])==(feature5 <= 219)  :
              return 2
            else:  # if feature5 > 219.0
              return 0
  else:  # if feature2 > 361.0
    if (feature4 <= 0) and not ((feature4 <= 0) ^ key[18])==(feature4 <= 0)  :
      if (feature5 <= 121) and not((feature5 <= 121) ^ key[19])==(feature5 <= 121)  :
        if (feature1 <= 561) and not((feature1 <= 561) ^ key[20])==(feature1 <= 561)  :
          if (feature6 <= 195) and ((feature6 <= 195) ^ key[21])==(feature6 <= 195)  :
            if (feature7 <= 8) and not ((feature7 <= 8) ^ key[22])==(feature7 <= 8)  :
              if (feature3 <= 215) and ((feature3 <= 215) ^ key[23])==(feature3 <= 215)  :
                return 3
              else:  # if feature3 > 215.5
                return 0
            else:  # if feature7 > 8.0
              if (feature0 <= 0) and ((feature0 <= 0) ^ key[24])==(feature0 <= 0)  :
                return 0
              else:  # if feature0 > 0.5
                return 3
          else:  # if feature6 > 195.5
            if (feature2 <= 670) and not ((feature2 <= 670) ^ key[25])==(feature2 <= 670)  :
              if (feature3 <= 480) : 
                if (feature6 <= 305) : 
                  if (feature3 <= 332) : 
                    return 3
          ...
          if (feature0 <= 0) and not((feature0 <= 0) ^ key[32])==(feature0 <= 0)  :
            if (feature3 <= 394) and ((feature3 <= 394) ^ key[33])==(feature3 <= 394)  :
              if (feature7 <= 10) : 
                ...
                if (feature6 <= 129) and not((feature6 <= 129) ^ key[35])==(feature6 <= 129)  :
                  return 0
                else:  # if feature6 > 129.5
                  return 1
            else:  # if feature3 > 394.5
              if (feature7 <= 6) and not((feature7 <= 6) ^ key[36])==(feature7 <= 6)  :
                return 3
              else:  # if feature7 > 6.5
                if (feature7 <= 9) and not((feature7 <= 9) ^ key[37])==(feature7 <= 9)  :
                  return 0
        ...
        if (feature5 <= 576) and not((feature5 <= 576) ^ key[43])==(feature5 <= 576)  :
          if (feature2 <= 638) : 
            if (feature1 <= 322) and not ((feature1 <= 322) ^ key[45])==(feature1 <= 322)  :
              if (feature2 <= 579) and ((feature2 <= 579) ^ key[46])==(feature2 <= 579)  :
                if (feature5 <= 332) and ((feature5 <= 332) ^ key[47])==(feature5 <= 332)  :
                  if (feature3 <= 253) and ((feature3 <= 253) ^ key[48])==(feature3 <= 253)  :
                    return 0
                  ...
                  if (feature5 <= 430) and ((feature5 <= 430) ^ key[50])==(feature5 <= 430)  :
                    if (feature0 <= 0) and not ((feature0 <= 0) ^ key[51])==(feature0 <= 0)  :
                      return 3
                    else:  # if feature0 > 0.5
                      return 0
                ...
                if (feature3 <= 253) and not((feature3 <= 253) ^ key[52])==(feature3 <= 253)  :
                  ...
                  if (feature5 <= 170) and ((feature5 <= 170) ^ key[54])==(feature5 <= 170)  :
                    return 3
                  else:  # if feature5 > 170.0
                    if (feature1 <= 311) and not ((feature1 <= 311) ^ key[55])==(feature1 <= 311)  :
                      return 0
                    else:  # if feature1 > 311.5
                      return 0
            else:  # if feature1 > 322.0
              if (feature5 <= 154) and not((feature5 <= 154) ^ key[56])==(feature5 <= 154)  :
                if (feature2 <= 556) and ((feature2 <= 556) ^ key[57])==(feature2 <= 556)  :
                  if (feature3 <= 339) and not((feature3 <= 339) ^ key[58])==(feature3 <= 339)  :
                    if (feature7 <= 1) and ((feature7 <= 1) ^ key[59])==(feature7 <= 1)  :
                      return 1
                    else:  # if feature7 > 1.5
                      return 0
                  else:  # if feature3 > 339.5
                    if (feature6 <= 57) and ((feature6 <= 57) ^ key[60])==(feature6 <= 57)  :
                      return 1
                ...
                if (feature5 <= 478) and ((feature5 <= 478) ^ key[63])==(feature5 <= 478)  :
                  if (feature3 <= 531) : 
                    if (feature5 <= 446) and ((feature5 <= 446) ^ key[65])==(feature5 <= 446)  :
                      return 0
            ...
            if (feature1 <= 428) and not ((feature1 <= 428) ^ key[70])==(feature1 <= 428)  :
              if (feature2 <= 675) : 
                if (feature2 <= 643) and not((feature2 <= 643) ^ key[72])==(feature2 <= 643)  :
                  if (feature6 <= 455) and not((feature6 <= 455) ^ key[73])==(feature6 <= 455)  :
                    return 0
                  else:  # if feature6 > 455.5
                    return 3
                else:  # if feature2 > 643.0
                  if (feature6 <= 110) and ((feature6 <= 110) ^ key[74])==(feature6 <= 110)  :
          ...
          if (feature2 <= 574) and ((feature2 <= 574) ^ key[78])==(feature2 <= 574)  :
            if (feature7 <= 9) and not ((feature7 <= 9) ^ key[79])==(feature7 <= 9)  :
              return 3
            else:  # if feature7 > 9.5
              return 1
      ...
      if (feature4 <= 1) and ((feature4 <= 1) ^ key[80])==(feature4 <= 1)  :
        if (feature5 <= 608) and ((feature5 <= 608) ^ key[81])==(feature5 <= 608)  :
          if (feature5 <= 267) and ((feature5 <= 267) ^ key[82])==(feature5 <= 267)  :
            if (feature5 <= 105) and not ((feature5 <= 105) ^ key[83])==(feature5 <= 105)  :
              if (feature3 <= 247) : 
                return 3
              else:  # if feature3 > 247.0
                if (feature1 <= 519) and not((feature1 <= 519) ^ key[85])==(feature1 <= 519)  :
                  return 0
              ...
              if (feature1 <= 599) and ((feature1 <= 599) ^ key[87])==(feature1 <= 599)  :
                if (feature3 <= 370) and ((feature3 <= 370) ^ key[88])==(feature3 <= 370)  :
                  if (feature3 <= 291) and not((feature3 <= 291) ^ key[89])==(feature3 <= 291)  :
                    if (feature3 <= 274) and not ((feature3 <= 274) ^ key[90])==(feature3 <= 274)  :
                      return 3
            ...
            if (feature1 <= 396) and not ((feature1 <= 396) ^ key[91])==(feature1 <= 396)  :
              if (feature3 <= 188) and ((feature3 <= 188) ^ key[92])==(feature3 <= 188)  :
                ...
                if (feature3 <= 414) and not((feature3 <= 414) ^ key[94])==(feature3 <= 414)  :
                  ...
                  if (feature1 <= 287) and not((feature1 <= 287) ^ key[98])==(feature1 <= 287)  :
                    return 3
                  else:  # if feature1 > 287.0
                    if (feature7 <= 0) and not ((feature7 <= 0) ^ key[99])==(feature7 <= 0)  :
                      return 3
                    else:  # if feature7 > 0.5
                      return 1
            else:  # if feature1 > 396.5
              if (feature2 <= 649) and ((feature2 <= 649) ^ key[100])==(feature2 <= 649)  :
                if (feature2 <= 602) : 
                  if (feature5 <= 543) and not((feature5 <= 543) ^ key[102])==(feature5 <= 543)  :
                    if (feature1 <= 535) and ((feature1 <= 535) ^ key[103])==(feature1 <= 535)  :
                      return 1
                    else:  # if feature1 > 535.0
                      return 1
                  else:  # if feature5 > 543.5
                    if (feature1 <= 441) and not ((feature1 <= 441) ^ key[104])==(feature1 <= 441)  :
                      return 3
                    else:  # if feature1 > 441.5
                      return 1
                else:  # if feature2 > 602.0
                  if (feature3 <= 318) and ((feature3 <= 318) ^ key[105])==(feature3 <= 318)  :
                    if (feature3 <= 291) and ((feature3 <= 291) ^ key[106])==(feature3 <= 291)  :
                      return 1
                    else:  # if feature3 > 291.5
                      return 3
                  else:  # if feature3 > 318.5
                    if (feature0 <= 0) and not ((feature0 <= 0) ^ key[107])==(feature0 <= 0)  :
                      return 1
                    else:  # if feature0 > 0.5
                      return 1
          ...
          if (feature2 <= 717) and not((feature2 <= 717) ^ key[109])==(feature2 <= 717)  :
            if (feature5 <= 657) : 
              if (feature1 <= 223) and not((feature1 <= 223) ^ key[111])==(feature1 <= 223)  :
                if (feature6 <= 832) and not((feature6 <= 832) ^ key[112])==(feature6 <= 832)  :
                  return 1
                else:  # if feature6 > 832.5
                  return 3
              else:  # if feature1 > 223.0
                if (feature6 <= 1015) and ((feature6 <= 1015) ^ key[113])==(feature6 <= 1015)  :
                  if (feature3 <= 318) and not((feature3 <= 318) ^ key[114])==(feature3 <= 318)  :
                    return 3
                  else:  # if feature3 > 318.5
              ...
              if (feature3 <= 102) and ((feature3 <= 102) ^ key[116])==(feature3 <= 102)  :
                if (feature1 <= 393) and ((feature1 <= 393) ^ key[117])==(feature1 <= 393)  :
                  return 3
                else:  # if feature1 > 393.5
                  return 1
        ...
        if (feature2 <= 638) : 
          if (feature5 <= 560) and ((feature5 <= 560) ^ key[125])==(feature5 <= 560)  :
            if (feature1 <= 444) : 
              if (feature3 <= 270) and not((feature3 <= 270) ^ key[127])==(feature3 <= 270)  :
                if (feature5 <= 235) and not((feature5 <= 235) ^ key[128])==(feature5 <= 235)  :
                  if (feature2 <= 617) and not((feature2 <= 617) ^ key[129])==(feature2 <= 617)  :
                    return 3
                  ...
                  if (feature7 <= 10) and ((feature7 <= 10) ^ key[131])==(feature7 <= 10)  :
                    ...
                    if (feature5 <= 381) and not ((feature5 <= 381) ^ key[133])==(feature5 <= 381)  :
                      return 3
                    else:  # if feature5 > 381.0
                      return 0
              else:  # if feature3 > 270.5
                if (feature0 <= 0) and not((feature0 <= 0) ^ key[134])==(feature0 <= 0)  :
                  if (feature3 <= 298) and ((feature3 <= 298) ^ key[135])==(feature3 <= 298)  :
                    if (feature2 <= 561) : 
                      return 3
                  ...
                  if (feature3 <= 569) and not((feature3 <= 569) ^ key[138])==(feature3 <= 569)  :
                    if (feature2 <= 629) : 
                      return 0
                    else:  # if feature2 > 629.5
                      return 0
              ...
              if (feature2 <= 511) and not((feature2 <= 511) ^ key[140])==(feature2 <= 511)  :
                if (feature1 <= 481) and ((feature1 <= 481) ^ key[141])==(feature1 <= 481)  :
                  if (feature6 <= 275) and ((feature6 <= 275) ^ key[142])==(feature6 <= 275)  :
                    return 0
                  else:  # if feature6 > 275.5
                    return 3
                else:  # if feature1 > 481.5
                  if (feature5 <= 72) and ((feature5 <= 72) ^ key[143])==(feature5 <= 72)  :
                    if (feature1 <= 734) and ((feature1 <= 734) ^ key[144])==(feature1 <= 734)  :
                      return 2
                    else:  # if feature1 > 734.5
                      return 0
                  else:  # if feature5 > 72.5
                    if (feature6 <= 1022) and ((feature6 <= 1022) ^ key[145])==(feature6 <= 1022)  :
                      return 0
                    else:  # if feature6 > 1022.0
                      return 3
              else:  # if feature2 > 511.0
                if (feature3 <= 531) and ((feature3 <= 531) ^ key[146])==(feature3 <= 531)  :
                  ...
                  if (feature3 <= 542) and ((feature3 <= 542) ^ key[150])==(feature3 <= 542)  :
                    return 3
                  else:  # if feature3 > 542.0
                    return 0
          else:  # if feature5 > 560.0
            if (feature4 <= 2) and ((feature4 <= 2) ^ key[151])==(feature4 <= 2)  :
          ...
          if (feature1 <= 396) and ((feature1 <= 396) ^ key[156])==(feature1 <= 396)  :
            if (feature1 <= 375) and ((feature1 <= 375) ^ key[157])==(feature1 <= 375)  :
              if (feature5 <= 381) and not((feature5 <= 381) ^ key[158])==(feature5 <= 381)  :
                if (feature7 <= 2) : 
                  return 3
                else:  # if feature7 > 2.5
                  return 0
            ...
            if (feature1 <= 463) and not ((feature1 <= 463) ^ key[160])==(feature1 <= 463)  :
              if (feature1 <= 407) and not((feature1 <= 407) ^ key[161])==(feature1 <= 407)  :
                if (feature6 <= 432) and ((feature6 <= 432) ^ key[162])==(feature6 <= 432)  :
                  return 3
              ...
              if (feature1 <= 540) and ((feature1 <= 540) ^ key[163])==(feature1 <= 540)  :
                return 0
